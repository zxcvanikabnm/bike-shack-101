...
class VariantSelects extends HTMLElement {
    ...
    onVariantChange(event) {
        // console.log("VariantSelects: onVariantChange", event);
        this.updateOptions();
        const newVariant = this.getVariantData().find((variant) =>
            variant.options.every(
                (option, index) => option === this.options[index]
            )
        );

        const oldVariant = this.currentVariant; // ✅ Save before updating
        this.currentVariant = newVariant; // ✅ Update now
        ...
        const myCustomEvent = new CustomEvent("afterVariantChange", {
            detail: {
                oldVariant,
        ...
        // console.log("🚀 Dispatching event with:");
        // console.log("Global JS OLD:", oldVariant);
        // console.log("Global JS NEW:", newVariant);
        ...
        fetch(
            ...
            .then((responseText) => {
                ...
                if (pricePerItemSource && pricePerItemDestination) {
                    pricePerItemDestination.innerHTML =
                        pricePerItemSource.innerHTML;
